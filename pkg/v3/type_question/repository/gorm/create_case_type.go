...
func (r *Repository) CreateCaseTypeQuestion(question presenter.TypeQuestionPresenter) (*models.TypeQuestion, error) {
	tsx = r.db.Begin()
...
func (r *Repository) createQuestion(question presenter.TypeQuestionPresenter) (*models.TypeQuestion, error) {
...
func (r *Repository) createNestedQuestions(question presenter.TypeQuestionPresenter, questionModel *models.TypeQuestion) error {
