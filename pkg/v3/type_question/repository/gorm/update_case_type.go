...
func (r *Repository) UpdateCaseTypeQuestion(question presenter.TypeQuestionPresenter) (*models.TypeQuestion, error) {
...
func (r *Repository) updateQuestion(question presenter.TypeQuestionPresenter) (*models.TypeQuestion, error) {
...
func (r *Repository) updateNestedQuestions(question presenter.TypeQuestionPresenter, questionModel *models.TypeQuestion) error {
