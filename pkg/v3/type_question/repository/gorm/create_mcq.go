...
func (r *Repository) CreateMCQQuestion(question *presenter.TypeQuestionPresenter) error {
	tsx := r.db.Begin()
	...
	// if err := r.db.Create(&questionModel).Error; err != nil {
	// 	return err
	// }
