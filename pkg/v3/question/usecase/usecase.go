...
*/
func New(repo interfaces.QuestionRepository, courseRepo interfaces.CourseRepository, subjectRepo interfaces.SubjectRepository, questionSetRepo interfaces.QuestionSetRepository, bookmarkRepo interfaces.BookmarkRepository) *usecase {
	return &usecase{
		repo:            repo,
