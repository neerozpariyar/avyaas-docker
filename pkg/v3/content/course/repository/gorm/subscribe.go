...
// func (repo *repository) SubscribeCourse(request presenter.SubscribeCourseRequest) error {
// 	var err error
// 	transaction := repo.db.Begin()

// 	pkg, err := repo.packageRepo.GetPackageByID(request.PackageID)
// 	if err != nil {
...
// 	expiryDate := time.Now().AddDate(0, 0, request.Period)
...
// 		}
// 	} else {
// 		return fmt.Errorf("already subscribed to the course package")
// 	}

// 	switch pkg.PackageTypeID {
// 	case 1:
// 		err = repo.MakeCourseSubscription(request.UserID, request.CourseID, transaction)
// 		if err != nil {
// 			transaction.Rollback()
// 			return err
// 		}
...
// 		err = repo.MakeLiveGroupSubscription(request.UserID, request.CourseID, pkg.LiveGroupID, transaction)
// 		if err != nil {
// 			transaction.Rollback()
// 			return err
// 		}
...
// 		err = repo.MakeLiveGroupSubscription(request.UserID, pkg.LiveGroupID, request.CourseID, transaction)
// 		if err != nil {
// 			transaction.Rollback()
// 			return err
// 		}
...
// 		}
// 	case 8:
// 		err = repo.MakeSingleTestSubscription(request.UserID, request.CourseID, pkg.TestID, transaction)
// 		if err != nil {
// 			transaction.Rollback()
// 			return err
// 		}
// 	case 9:
// 		err = repo.MakeSingleLiveSubscription(request.UserID, request.CourseID, pkg.LiveID, transaction)
// 		if err != nil {
// 			transaction.Rollback()
// 			return err
// 		}
...
// 	studentCourse, err := repo.CheckStudentCourse(userID, courseID)
// 	if err != nil {
// 		return err
// 	}
